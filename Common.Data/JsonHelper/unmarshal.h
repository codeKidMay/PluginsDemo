...
#define __JSON_HELPER_UNMARSHAL_SINGLE_FIELD__(root, field)                                                        \
 std::cout << "[JsonHelper][Unmarshal][Debug] parse class field [" << #field << "]" << std::endl; \
...
#define JSON_HELPER_UNMARSHAL_MEMBER_FUNCTION(...)                                                           \
 bool Unmarshal(const Json::Value& root) {                                                                 \
    bool ret = true;                                                                                       \
    UNMARSHAL_MEMBERS(root, __VA_ARGS__)                                                                     \
    return ret;                                                                                            \
 }

#define UNMARSHAL_MEMBERS(root, ...)                                                                         \
 UNMARSHAL_MEMBERS_IMPL(root, __VA_ARGS__, UNMARSHAL_MEMBERS_END)

#define UNMARSHAL_MEMBERS_IMPL(root, head, ...)                                                              \
 __JSON_HELPER_UNMARSHAL_SINGLE_FIELD__(root, head)                                                          \
 UNMARSHAL_MEMBERS_IMPL_NEXT(root, __VA_ARGS__)
